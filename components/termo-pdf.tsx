    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        <Text style={styles.paragraph}>
          ...
          Alexandro Willemann da Silva, doravante denominada "EMPRESA" e de outro lado, {formData.nomeFunc.toUpperCase()}, portador do
      ...
      <View style={styles.section}>
        ...
        <Text style={{ ...styles.paragraph, fontWeight: 'bold' }}>
          - Coletor Zebra (TC-21), N° de Série: {formData.numSerie}
        </Text>
